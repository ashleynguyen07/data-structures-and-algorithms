...
public class Manager {
    ...
    public static int countLine() {
        int countLine = 0;
        try {
            BufferedReader br = new BufferedReader(new FileReader(new File("/Users/tramy/Documents/Learning Uni/Semester 3/LAB211/LAB/WEEK 4/NormalizeText/src/test.txt")));
